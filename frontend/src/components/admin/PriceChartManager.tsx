        ...
        <div className="bg-white shadow-lg rounded-xl p-8 border border-gray-200">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                <label htmlFor="booking_price" className="block text-sm font-medium text-gray-700">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal focus:border-teal transition-colors duration-200"
                    placeholder="Defaults to standard price"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label htmlFor="notes" className="block text-sm font-medium text-gray-700">
                Notes & Inclusions for this Price <span className="text-gray-400 font-normal">(Optional)</span>
              </label>
              <textarea
                id="notes"
                rows={2}
                {...register('notes')}
                className="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal focus:border-teal transition-colors duration-200"
                placeholder="e.g., Includes conservancy fees, minimum 2 nights stay, single supplement +$100"
              />
            </div>
            ...
            <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
              ...
              >
               ...
               >
                {isSubmitting ? 'Saving...' : editingChart ? 'Update Chart' : 'Create Chart'}
              </button>
            </div>
          </form>
        </div>
      ...
      <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
        {isLoading ? (
          ...
          <div className="text-center py-16 px-6">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">No seasonal price charts yet</h3>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {priceCharts.map((chart) => (
                  <tr key={chart.id} className="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-base font-bold text-gray-900">${chart.price.toFixed(2)}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-base font-bold text-primary">
                        ${(chart.booking_price ?? chart.price).toFixed(2)}
                      </div>
                    </td>
                    <td className="px-6 py-4 max-w-xs text-xs text-gray-600 truncate">
                      {chart.notes || '—'}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-xs font-medium">
                      <div className="flex justify-end space-x-2">
                        <button
                          ...
                          className="px-2.5 py-1 border border-gray-300 rounded text-xs font-semibold text-gray-700 hover:bg-gray-50"
                        >
                          Edit
                        </button>
                        <button
                          ...
                          className="px-2.5 py-1 border border-red-300 rounded text-xs font-semibold text-red-700 hover:bg-red-50"
                        >
                          Delete
                        </button>
                      </div>
