  ...
  const renderIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'labels':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4zM17 3h1a2 2 0 012 2v1" />
          </svg>
        );
      default:
        return (
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <div className="fixed inset-0 flex z-40">
            <div className="relative flex-1 flex flex-col max-w-xs w-full bg-charcoal">
          ...
          <div className="flex-1 px-4 flex justify-between">
            ...
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <a
                ...
                className="bg-white p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal"
              >
