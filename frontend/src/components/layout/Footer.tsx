      ...
      <div className="container mx-auto px-4">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block mb-4">
              {logo ? (
                ...
                <h2 className="text-xl font-playfair text-white">AllBounds Vacations</h2>
              )}
            </Link>
            <p className="text-sm mb-4">
              Discover extraordinary destinations and create unforgettable memories with AllBounds Vacations.
            </p>
            {socialLinks && (
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <p className="text-center text-sm text-gray-400">
            &copy; {currentYear} AllBounds Vacations. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
