...
const CountryForm: React.FC<CountryFormProps> = ({ countryData, isEdit = false }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Sub-menu Section Navigation Tabs */}
      <div className="bg-white shadow-sm border border-gray-200/80 rounded-xl overflow-hidden">
        <div className="flex overflow-x-auto p-2 bg-gray-50/80 gap-1.5 border-b border-gray-200/80 scrollbar-none">
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-xs md:text-sm font-semibold whitespace-nowrap transition-all ${
                  isActive
