...
const DestinationFAQItem: React.FC<DestinationFAQItemProps> = ({
    ...
    return (
        <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:border-primary/30">
            ...
            >
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <h3 className="text-base sm:text-lg md:text-xl font-bold text-charcoal font-playfair leading-tight mb-1">
                                {faq.question}
                            </h3>
                        </div>
                    </div>
