...
const ContactUsCard: React.FC = () => {
  return (
    <>
      <section className="py-16" style={{ backgroundColor: '#ecebdd' }}>
      ...
      <section className="py-16" style={{ backgroundColor: '#d3d0c6' }}>
        <div className="container mx-auto px-4">
          {/* Feature Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="group">
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                {/* Badge */}
                <div className="absolute top-6 left-6">
                  <span className="inline-flex items-end px-3 py-1 rounded-full text-xs font-medium text-white shadow-lg" style={{ backgroundColor: '#58e5b1', fontFamily: 'Lato, sans-serif' }}>
